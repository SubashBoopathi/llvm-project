...
define dso_local spir_kernel void @test(float %a, i32 %in, i32 %ui, float* %out) local_unnamed_addr #0 !kernel_arg_addr_space !5 !kernel.arg_access_qual !6 !kernel.arg_type !7 !kernel.arg_base_type !7 !kernel.arg_type_qual !8 !kernel.arg_buffer_location !9 {
entry:
  ...
  %rem = tail call float @llvm.experimental.constrained.frem.f32(float %a, float %add, metadata !"round.tonearest", metadata !"fpexcept.strict") #2
  %arrayidx = getelementptr inbounds float, float* %out, i64 0
  store float %rem, float* %arrayidx, align 4
  ret void
}
...
!5 = !{i32 0, i32 0, i32 0, i32 1} ; Updated: Added address space for output buffer (global memory)
!6 = !{!"none", !"none", !"none", !"write_only"} ; Updated: Access qualifier for output buffer
!7 = !{!"float", !"int", !"uint", !"float*"} ; Updated: Added type for output buffer
!8 = !{!"", !"", !"", !""} ; Updated: Type qualifier for output buffer
!9 = !{i32 -1, i32 -1, i32 -1, i32 -1} ; Updated: Buffer location for output buffer
