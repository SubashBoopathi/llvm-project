; RUN: llc -verify-machineinstrs -O0 -mtriple=spirv32-unknown-unknown --spirv-ext=+SPV_INTEL_task_sequence 2>&1 %s -o - | FileCheck %s

; XFAIL:*

; CHECK: InvalidInstruction: Can't translate llvm instruction:
; CHECK-NEXT: TaskSequenceCreateINTEL
; CHECK-NEXT: Pipeline must be a 32 bit integer with the value bigger or equal to -1
