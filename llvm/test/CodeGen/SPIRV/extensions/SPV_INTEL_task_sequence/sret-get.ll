...
; CHECK: %[[#TypeTS:]] OpTaskSequenceINTEL
; CHECK: %[[#TypeStruct:]] = OpTypeStruct %[[#]] %[[#]] %[[#]]
; CHECK: %[[#TSCreateId:]] = OpTaskSequenceCreateINTEL %[[#TypeTS]] %[[#]] %[[#]] %[[#]]
; CHECK: %[[#Get:]] = OpTaskSequenceGetINTEL %[[#TypeStruct]] %[[#TSCreateId]] 
; CHECK: OpStore %[[#]] %[[#Get]]
