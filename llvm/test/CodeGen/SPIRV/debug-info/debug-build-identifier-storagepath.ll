...
; CHECK-MIR-DAG: [[string_file:%[0-9]+\:id\(s32\)]] = OpString {{[0-9 ,]+}}, 27747
...
; CHECK-MIR-DAG: [[debug_comp_unit:%[0-9]+\:id\(s32\)]] = OpExtInst [[void_type]], 3, 1, [[i32_3]], [[i32_1]], [[debug_source]], [[i32_12]]
; CHECK-MIR-DAG: [[debug_build_id:%[0-9]+\:id\(s32\)]] = OpExtInst [[void_type]], 3, 105, [[string_build_id]], [[i32_0]]
...
; CHECK-SPIRV-DAG: [[string_file:%[0-9]+]] = OpString "/path/to/source/debug_build_storage.cl"
...
; CHECK-SPIRV-DAG: [[debug_comp_unit:%[0-9]+]] = OpExtInst [[void_type]] {{%[0-9]+}} DebugCompilationUnit [[i32_3]] [[i32_1]] [[debug_source]] [[i32_12]]
; CHECK-SPIRV-DAG: [[debug_build_id:%[0-9]+]] = OpExtInst [[void_type]] {{%[0-9]+}} DebugBuildIdentifier [[string_build_id]] [[i32_0]]
...
!0 = distinct !DICompileUnit( language: DW_LANG_C99, file: !1, producer: "clang version test", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, splitDebugFilename: "debug_storage_path.spv", dwoId: 1234567890, enums: !2, retainedTypes: !2, globals: !2, imports: !2)
